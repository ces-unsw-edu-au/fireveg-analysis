...
# 1. Download the zip files into your local desktop ----
# URL of the zip file
url <- "https://figshare.com/ndownloader/articles/24125088/versions/2"

# Destination path to save the file
destfile <- "~/Publications/Ferrer_Paris_ et al_Fireveg/Figshare_documents/data.zip"
  
# "practical_examples/data.zip"
...
# 2. Unzip the file ----
unzip(destfile, exdir = "~/Publications/Ferrer_Paris_ et al_Fireveg/Figshare_documents/input") # Create the folder input with the unzipped data
